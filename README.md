...
Final-year CS at [VIT Chennai](https://chennai.vit.ac.in), and on the founding team at **WiseFolio**, an early-stage fintech where I build the data and payment layers behind an equities investing platform. Most of what's left of my week goes to open source in the Python finance ecosystem.
...
**Backend** &nbsp;Python · FastAPI · SQLAlchemy · Postgres · Redis  
**Frontend** &nbsp;TypeScript · React · Next.js · Tailwind  
**Infra** &nbsp;Docker · AWS · GitHub Actions

Comfortable in C++ and Node when a problem calls for them.
